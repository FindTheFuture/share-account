  ...
  <view class="container">
    ...
    <view class="actions-wrapper">
      ...
      <label class="agreement-label">
        <checkbox :checked="agreed" value="agree" /> 我已阅读并同意
        <navigator url="/pages/usercenter/mycenter/agreementText/agreementText" hover-class="none">
          <text class="agreement-link">《用户协议》</text>
        </navigator>
        及
        <navigator url="/pages/usercenter/mycenter/privacyText/privacyText" hover-class="none">
          <text class="agreement-link">《隐私保护指引》</text>
        </navigator>
      </label>
    </checkbox-group>
